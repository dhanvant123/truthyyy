...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (password !== confirmPassword) {
      setError('Blockchain keys must be entangled');
      setIsLoading(false);
      return;
    }
    ...
    <div className="min-h-screen bg-[#030712] text-white overflow-hidden relative">
      ...
      <nav className="relative z-10 px-8 py-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <Link href="/login" className="text-gray-400 hover:text-yellow-400 transition-colors text-sm tracking-wide group relative overflow-hidden">
            <span className="relative z-10 group-hover:translate-y-1 transform transition-transform">EXISTING PROTOCOL? →</span>
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-8 py-12">
        <div className="w-full max-w-md">
          <div className="relative group">
            ...
            <div className="absolute -inset-1 bg-gradient-to-r from-yellow-600 via-orange-600 to-amber-600 rounded-3xl blur opacity-25 animate-pulse"></div>
            ...
            <div className="relative bg-[#030712] border border-yellow-500/20 rounded-3xl p-10 backdrop-blur-xl transform hover:rotate-1 transition-all duration-700">
              ...
              <div className="text-center mb-10">
                ...
                <h1 className="text-3xl font-light mb-2 text-gray-200 group-hover:text-yellow-300 transition-colors duration-500">BLOCKCHAIN CREATION</h1>
                <p className="text-gray-500 text-sm tracking-wide group-hover:text-gray-400 transition-colors duration-500">Establish your truth protocol</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="space-y-3">
                  <label className="text-xs font-medium text-gray-400 tracking-wider">BLOCKCHAIN SIGNATURE</label>
                  <div className="relative">
                    <input
                      ...
                      placeholder="Dr. Blockchain Matrix"
                    ...
                    <div className={`absolute right-4 top-1/2 transform -translate-y-1/2 transition-all duration-300 ${
                      name ? 'opacity-100 scale-110' : 'opacity-0 scale-75'
                    }`}>
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onBlur={() => setFocusedField('')}
                      placeholder="your.blockchain.matrix@"
                      className={`w-full px-5 py-4 bg-yellow-950/30 border rounded-2xl text-white placeholder-gray-600 focus:outline-none transition-all duration-500 ${
                        focusedField === 'email' 
                          ? 'border-yellow-500 bg-yellow-950/50 shadow-lg shadow-yellow-500/20' 
                          : 'border-yellow-500/20 hover:border-yellow-500/40'
                ...
                {/* Password Field */}
                <div className="space-y-3">
                  <label className="text-xs font-medium text-gray-400 tracking-wider">PRIMARY ENCRYPTION</label>
                  <div className="relative">
                    <input
                      type="password"
                      value={password}
                ...
                <div className="space-y-3">
                  <label className="text-xs font-medium text-gray-400 tracking-wider">ENTANGLED KEY</label>
                  <div className="relative">
                    <input
                      type="password"
                    ...
                    />
                    <div className={`absolute right-4 top-1/2 transform -translate-y-1/2 transition-all duration-300 ${
                      confirmPassword && password === confirmPassword ? 'opacity-100 scale-110' : 'opacity-0 scale-75'
                    }`}>
                      <span className="text-yellow-400">⬡</span>
                    </div>
                  </div>
                ...
                >
                  {isLoading ? (
                    ...
                    <span className="relative z-10">CREATE BLOCKCHAIN PROTOCOL</span>
                  )}
